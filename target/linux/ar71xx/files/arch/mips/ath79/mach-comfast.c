...
#define CF_E350N_GPIO_LED_WAN1		4
#define CF_E350N_GPIO_LED_LAN1		16
#define CF_E350N_GPIO_LED_LAN2		15
#define CF_E350N_GPIO_LED_LAN3		14
#define CF_E350N_GPIO_LED_LAN4		11
...
static void __init comfast_cf_e350n_setup(void)
{
	...
	ath79_gpio_output_select(CF_E350N_GPIO_LED_WAN1, 0);
...
MIPS_MACHINE(ATH79_MACH_COMFAST_CF_E350N, "COMFAST-CF-E350N", "COMFAST CF-E350N",
	     cf_e350n_setup);
	     
#define CF_E355AC_GPIO_BTN_RESET	17

#define CF_E355AC_KEYS_POLL_INTERVAL	20	/* msecs */
#define CF_E355AC_KEYS_DEBOUNCE_INTERVAL (3 * CF_E355AC_KEYS_POLL_INTERVAL)
...
#define CF_E355AC_GPIO_LED_WAN1		4
#define CF_E355AC_GPIO_LED_LAN1		16
#define CF_E355AC_GPIO_LED_LAN2		15
#define CF_E355AC_GPIO_LED_LAN3		14
#define CF_E355AC_GPIO_LED_LAN4		11
...
static struct gpio_led cf_e355ac_leds_gpio[] __initdata = {
	{
		...
		.name		= "comfast:green:lan2",
		.gpio		= CF_E355AC_GPIO_LED_LAN2,
		.active_low	= 1,
	}, {
		.name		= "comfast:green:lan3",
		.gpio		= CF_E355AC_GPIO_LED_LAN3,
		.active_low	= 1,
	}, {
		.name		= "comfast:green:lan4",
		.gpio		= CF_E355AC_GPIO_LED_LAN4,
		.active_low	= 1,
	}, 
};
...
static struct gpio_keys_button cf_e355ac_gpio_keys[] __initdata = {
	{
		...
		.type		= EV_KEY,
		.code		= KEY_RESTART,
		.debounce_interval = CF_E355AC_KEYS_DEBOUNCE_INTERVAL,
...
static void __init comfast_cf_e355ac_setup(void)
{
	...
	ath79_gpio_output_select(CF_E355AC_GPIO_LED_WAN1, 0);
	ath79_gpio_output_select(CF_E355AC_GPIO_LED_LAN1, 0);
	ath79_gpio_output_select(CF_E355AC_GPIO_LED_LAN2, 0);
	ath79_gpio_output_select(CF_E355AC_GPIO_LED_LAN3, 0);
	ath79_gpio_output_select(CF_E355AC_GPIO_LED_LAN4, 0);
...
static void __init cf_e355ac_setup(void)
{
	...
	ath79_register_gpio_keys_polled(1, CF_E355AC_KEYS_POLL_INTERVAL,
					ARRAY_SIZE(cf_e355ac_gpio_keys),
					cf_e355ac_gpio_keys);
}

MIPS_MACHINE(ATH79_MACH_COMFAST_CF_E355AC, "COMFAST-CF-E355AC", "COMFAST CF-E355AC",
	     cf_e355ac_setup);
